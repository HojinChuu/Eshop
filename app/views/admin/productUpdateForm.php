        ...
        <div class="card card-body mt-5">
            ...
            <form action="<?= URLROOT ?>/products/update/<?= $data['id'] ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control form-control-lg" value="<?= $data['name'] ?>" require>
                </div>
                <div class="form-group">
                    <label for="description">Description</label>
                    <textarea name="description" class="form-control form-control-lg" rows="5" require><?= $data["description"] ?></textarea>
                </div>
                <div class="form-group">
                    <label for="description">Image</label>
                    <input type="file" name="image" class="form-control form-control-sm" require />
                </div>
                <div class="form-group">
                    <label for="description">Price</label>
                    <input type="number" name="price" class="form-control form-control-lg" value="<?= $data['price'] ?>" require />
                </div>
                <div class="form-group">
